    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_name', models.CharField(help_text='The name of this Openuser data. Spaces are replaces with underscores', max_length=20, validators=[django.core.validators.RegexValidator(message='Must begin and end with a letter. And can only contain letters, numbers and hyphens', regex='^[a-zA-Z]([\\w -]*[a-zA-Z])?$'), django.core.validators.MinLengthValidator(limit_value=4)], verbose_name='App Name')),
                ...
                ('password', models.CharField(help_text='User password', max_length=20, validators=[django.core.validators.MinLengthValidator(limit_value=8), django.core.validators.RegexValidator(inverse_match=True, message='Password cannot contain spaces', regex='\\s')], verbose_name='Password')),
                ...
                ('mugshot', models.URLField(help_text='Users mugshot url', max_length=255, verbose_name='Mugshot')),
                ('dob', models.DateField(verbose_name='Date of Birth')),
                ('about', models.TextField(help_text='About me', verbose_name='About')),
